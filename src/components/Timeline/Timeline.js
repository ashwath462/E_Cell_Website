        ...
        <Container fluid>
          ...
          <Row>
            ...
            <TimelineCard
                ...
                src={require("assets/img/sections/Legacy_reunion.jpeg")}
              />
              <TimelineCard
                date="May 2021"
                icon={<EmojiObjectsIcon />}
                iconStyle={{ background: "rgb(33, 150, 243)", color: "#fff" }}
                title="Prerna Conclave"
                src={require("assets/img/sections/Prerna.jpeg")}
              />
              <TimelineCard
                date="Dec 2020"
                ...
                src={require("assets/img/sections/Freshman_Orientation.jpeg")}
              />
              <TimelineCard
                date="Coming Soon"
                icon={<EventIcon />}
