                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={e => e.preventDefault()}>
                          <img
                            ...
                            src={require("assets/img/Events/legacycanva.jpg")}
                          />
                        </a>
                      </div>
                      <CardBody>
                        ...
                        <a href="javascrip: void(0);">
                          <CardTitle tag="h3">
                          Legacy - E-Cell Reunion
                          </CardTitle>
                        </a>
                        <div className="card-description">
                          <p>
                          IET DAVV alumni who contributed to E-Cell and were some of the former members who helped
                          it evolve during the initial stages were invited to elucidate their experiences and were bid a
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={e => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img img-raised"
                            src={require("assets/img/Events/Dravya.jpg")}
                          />
                        </a>
                      </div>
                      <CardBody>
                        ...
                        <a href="javascrip: void(0);">
                          <CardTitle tag="h3">
                          Dravya - Finance Session
                          </CardTitle>
                        </a>
                        <div className="card-description">
                          <p>
                          A workshop on financial literacy was conducted by HerMoney Talks and BSE India. Students
                          were provided with all the necessary information about efficient future planning and how to
                          enhance their financial quotient.
                          </p>
                        </div>
                      ...
                      <div className="card-image">
                        <a href="#pablo" onClick={e => e.preventDefault()}>
                          <img
                            alt="..."
                            className="img img-raised"
                            src={require("assets/img/Events/Freshmen2020.png")}
                          />
                        </a>
                      </div>
                      <CardBody>
                        ...
                        <a href="javascrip: void(0);">
                          <CardTitle tag="h3">
                          Freshmen Orientation 2020
                          </CardTitle>
                        </a>
                        <div className="card-description">
                          <p>
                          Due to the Covid-19 pandemic, colleges continued functioning in online mode. The new batch
                          of budding engineers was greeted and introduced to the college through an online orientation.
                          </p>
                        </div>
